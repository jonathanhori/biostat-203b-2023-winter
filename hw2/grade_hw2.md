...
- Q7 (15/20)
    ...
    We should define `age at admission` and use this grater than 18. `-5.0`
    
    We suggest using `deathtime - admittime` instead of `dod - admittime` with more `NA`. No points off.

- Q8 (20/20)

    Again, we should define `age at admission` instaad of `anchor_age`. No points off.
...
- [Rule 2.5](https://style.tidyverse.org/syntax.html#long-lines) The maximum line length is 80 characters.  
    ...
    You do not care about outside the chunk.
    
    Lines 160, 314, 331, 403, 491, 654, 779, etc.
