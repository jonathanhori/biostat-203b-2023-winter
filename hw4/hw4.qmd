...
# best_logit.config <- workflow_cv_fit %>% 
#   extract_workflow_set_result("simple_logit") %>% 
#   select_best("roc_auc")
# 
# # Finalized model
# best_logit <- workflow_cv_fit %>% 
#   extract_workflow()
...
# # Best model parameters
# best_rf.config <- workflow_cv_fit %>% 
#   extract_workflow_set_result("simple_rf") %>% 
#   select_best("roc_auc")
# 
# # Finalized model
# best_rf <- workflow_cv_fit %>% 
#   extract_workflow("simple_rf") %>% 
#   finalize_workflow(best_rf.config) %>% 
#   last_fit(data_split)
